...
-->
  ...
  <body>
    ...
    <div class="products">
      <div class="container">
        <div class="row">
          <h1 style="font-family: verdana; margin: 10px; font-size: 30px;"> Our Menus <h1>
  ...
  <img src='admin/image/$i' alt=''>
   <div class='down-content'>
                          <a href='login.php?img=$i'><h4 style='font-family: verdana;'>".$arr['prod_no']."</h4></a>
                          <h6>".$arr['price']."</h6>
  ...
  $n++;
   	  ...
   	  echo "</form></table></tr></div></div></div></div>
      </div></div>";
	?>	  
